...
<!--      <div class="txt right">
    ...
    <ul onclick="return false" onclick class="slides slideX2 stickySlide" id="trans1">
        ...
        <li><img  src="<?php echo $fsConfig->getUrl() ?>img/i4.JPG" alt="Imagen"></li>
        <li><img  src="<?php echo $fsConfig->getUrl() ?>img/i5.JPG" alt="Imagen"></li>
<!--        <li><img  src="<?php echo $fsConfig->getUrl() ?>img/i2.jpg" alt="Imagen"></li>-->
        <li><img  src="<?php echo $fsConfig->getUrl() ?>img/d1.JPG" alt="Imagen"></li>

        <li ><img  src="<?php echo $fsConfig->getUrl() ?>img/i1.jpg"  alt="Imagen"></li>
<!--        <li ><img  src="<?php echo $fsConfig->getUrl() ?>img/i4 - copia.jpg"  alt="Imagen"></li>-->
    </ul>
...
<div class="contentX2 contentX2x">
    <div class="divBar"><img  class="bar1" src="<?php echo $fsConfig->getUrl() ?>img/bar1s.png"/></div>
    <div >
    <a  href="#"><img class="contentImg" src="<?php echo $fsConfig->getUrl() ?>img/logo.png" alt="Buga Logo"/></a>
    </div>
...
<div class="contentX2 right">
    <a href=""><img class="contentImg2" src="<?php echo $fsConfig->getUrl() ?>img/logo.png" alt="Buga Logo"/></a>
        ...
        <section class="container-fluid">
            <div class="columnaX">
                <article class="articuloX articulo">    
                    <a>
                        <img class="imgarticle" src="<?php echo $fsConfig->getUrl() ?>img/i800 b.jpg" alt="Imagen">
                    </a>
...
<!--<div id="footer">
    ...
    <a href="<?php echo $fsConfig->getUrl() . "index.php" ?>">http://www.BugaTravels.co.uk</a>
 <div class="copyright"><p>Desarrollado por <a href="#">OneCreative</a></p></div>
 </div>-->
