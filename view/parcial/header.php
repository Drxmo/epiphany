...
<div class="theHeader" >
    <header class="headerX" ><h1 class="h1X"><a style="color:blue" class="TitleX" href="<?php echo $fsConfig->getUrl() ?>index.php/home/index" title="Destino Travel" rel="home"><span class="TitleX"><span >B</span>uga<span >T</span>ravel<span >s</span><img class="logohead"  src="<?php echo $fsConfig->getUrl() ?>img/logo.png" alt="Buga Logo"/></span></a></h1>
                ...
                <div class="collapse navbar-collapse fijoX" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="floatRightX">
                        ...
                        <ul class="nav navbar-nav navbar-right navbar-rightX">
                            ...
                            <li><a class="identificarse" style="display:none" href="<?php echo $fsConfig->getUrl() ?>index.php/home/lista">Identificarse</a></li>
